...
import UIKit
    ...
    class DebugViewController: UITableViewController, Storyboarded
    {
        ...
        @IBOutlet var potentiallyExposedSwitch: UISwitch!
        ...
        @IBOutlet var bluetoothStatus: UIView!
        @IBOutlet var bluetoothImage: UIImageView!
        var fillLayer: CAShapeLayer!

        @IBOutlet var broadcasterStatus: UIImageView!
        @IBOutlet var listenerStatus: UIImageView!
        ...
        override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
        {
            ...
            case (3, 0):
                do
                {
                    ...
                    URLSession.shared.execute(request, queue: .main)
                    { result in
                        switch result
                        {
                        case .success:
        ...
        @IBAction func unwindFromSetDiagnosis(unwindSegue _: UIStoryboardSegue)
        {}
