...
@objc class PersistingContactEventRepository: NSObject, ContactEventRepository
{
    ...
    func btleListener(_: BTLEListener, didFind broadcastPayload: IncomingBroadcastPayload, for peripheral: BTLEPeripheral)
    {
    ...
    func btleListener(_: BTLEListener, didReadTxPower txPower: Int, for peripheral: BTLEPeripheral)
    {
    ...
    func btleListener(_: BTLEListener, didReadRSSI RSSI: Int, for peripheral: BTLEPeripheral)
    {
        var event = persister.items[peripheral.identifier] ?? ContactEvent()
